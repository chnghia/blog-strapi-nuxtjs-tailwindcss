        ...
        >
          ...
          <div>
            ...
            <h2 class="text-3xl md:text-4xl font-extrabold mb-4">
              We are <span class="font-light">TechCode</span>
            </h2>
            <h3
              class="text-lg md:text-xl md:leading-relaxed font-medium lg:w-1/2 text-gray-600"
            >
            ...
            <div>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                  class="text-red-500 hi-solid hi-heart inline-block w-5 h-5"
                >
                  <path
                    fill-rule="evenodd"
            ...
            <div>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                  class="text-blue-500 hi-solid hi-arrow-down inline-block w-5 h-5"
                >
                  <path
                    fill-rule="evenodd"
            ...
            <div>
              ...
              >
                <svg
                  ...
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                  class="text-pink-500 hi-solid hi-cube-transparent inline-block w-5 h-5"
                >
                  <path
                    fill-rule="evenodd"
