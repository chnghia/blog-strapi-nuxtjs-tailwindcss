  ...
  <div class="bg-white">
    <div class="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32">
      ...
      >
        <div>
          <span
            class="inline-block font-semibold bg-indigo-100 text-indigo-700 px-2 py-1 rounded"
          >120</span>
          products
        </div>
      ...
      >
        <div>
          <div class="group relative overflow-hidden mb-2">
            ...
            >
            <div
              class="p-4 flex items-center justify-center absolute inset-0 bg-indigo-900 bg-opacity-90 transform transition ease-out opacity-0 scale-150 group-hover:opacity-100 group-hover:scale-100"
            >
      ...
      <div>
        <nav class="flex sm:hidden">
          ...
          <div class="flex items-center grow justify-center px-2 sm:px-4">
            <span>Page <span class="font-semibold">1</span> of
