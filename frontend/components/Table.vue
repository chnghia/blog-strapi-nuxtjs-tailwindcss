    ...
    <table class="min-w-full text-sm align-middle whitespace-nowrap">
      ...
      <tbody>
        <tr class="border-b border-gray-200">
          ...
          <td class="p-3 text-center">
            <div
              class="font-semibold inline-flex px-2 py-1 leading-4 text-xs rounded-full text-emerald-700 bg-emerald-200"
            >
              Agency
            </div>
          </td>
        ...
        <tr class="border-b border-gray-200">
          ...
          <td class="p-3 text-center">
            <div
              class="font-semibold inline-flex px-2 py-1 leading-4 text-xs rounded-full text-blue-700 bg-blue-200"
            >
              Freelancer
            </div>
          </td>
        ...
        <tr class="border-b border-gray-200">
          ...
          <td class="p-3 text-center">
            <div
              class="font-semibold inline-flex px-2 py-1 leading-4 text-xs rounded-full text-orange-700 bg-orange-200"
            >
              Trial
            </div>
          </td>
